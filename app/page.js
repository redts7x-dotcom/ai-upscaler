  ...
  return (
    <main dir="rtl" style={{ 
      ...
      <div style={{ maxWidth: '850px', margin: '0 auto', padding: '80px 20px', textAlign: 'center' }}>
        ...
        <div {...getRootProps()} style={{ border: `1px solid ${isDragActive ? '#fff' : 'rgba(255,255,255,0.1)'}`, padding: '100px 40px', borderRadius: '40px', backgroundColor: 'rgba(255,255,255,0.03)', backdropFilter: 'blur(25px)', cursor: 'pointer' }}>
          <input {...getInputProps()} />
        ...
        <AnimatePresence>
          {result && (
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} style={{ marginTop: '60px', background: 'rgba(255,255,255,0.03)', padding: '30px', borderRadius: '40px', border: '1px solid rgba(255,255,255,0.1)', backdropFilter: 'blur(20px)' }}>
              <img src={result} style={{ width: '100%', borderRadius: '25px', marginBottom: '25px' }} alt="Result" />
